...
class absenteeism_model():
    ...
    def load_and_clean_data(self, data_file):
        ...
        # assign names to the 4 reason type columns note: there is a more universal version of this code,
        # however the following will best suit our current purposes
        ...
        # re-order the columns in df
        column_names_upd = ['Reason 1', 'Reason 2', 'Reason 3', 'Reason 4', 'Months value', 'Day of the Week',
